...
export default {
    ...
    methods: {
        goToOrderForm() {
            ...
            window.top.location.href = `https://shop.customessaymeister.com/order/new?type=${this.type}&academiclevel=${this.academiclevel}&pages=${this.pages}&date=${this.datetime}`
        },
    }
}
</script>
