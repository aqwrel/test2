...
export default {
    ...
    methods: {
        goToOrderForm() {
            ...
            window.top.location.href = `https://shop.professays.com/order/new?type=${this.type}&academiclevel=${this.academiclevel}&pages=${this.pages}&date=${this.datetime}`
        },
    }
}
</script>
...
<style lang="scss">
    @import '~/assets/styles/site_specific_styles/professays.com/index.scss';
</style>